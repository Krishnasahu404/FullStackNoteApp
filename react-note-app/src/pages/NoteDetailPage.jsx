...
const NoteDetailPage = ({deleteNotes}) => {
  ...
  return (
    ...
    <span className="d-flex justify-content-center">
        ...
        <p className="note-date font-12 text-muted me-5">last updated: {FormatDate(note.update)}</p>
    </span>
  ...
  { isOpen && <Modal handleIsOpen={handleIsOpen} deleteNotes={()=>deleteNotes(slug)}/>}
  </>
